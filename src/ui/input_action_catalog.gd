...
const KEYBOARD_DEFAULT_LABELS: Dictionary = {
	...
	&"redo": "Ctrl+Y",
	&"launch_focus": "Space",
	&"pause_playback": "Space",
	&"speed_up": "]",
	&"speed_down": "[",
	&"tick_step": ".",
	&"review_event_previous": "Page Up",
	&"review_event_next": "Page Down",
	&"jump_failed_predicate": "F",
	&"jump_root_cause": "J",
	&"compare_start_final": "C",
	&"panel_next": "E",
	&"panel_previous": "Q",
}

const CONTROLLER_DEFAULT_LABELS: Dictionary = {
	&"navigate_up": "D-pad Up",
	&"navigate_down": "D-pad Down",
	&"navigate_left": "D-pad Left",
	&"navigate_right": "D-pad Right",
	&"accept": "South / A",
	&"cancel": "East / B",
	&"inspect": "North / Y",
	&"rotate": "West / X",
	&"remove": "Right Stick Click",
	&"region_next": "Right Shoulder",
	&"region_previous": "Left Shoulder",
	&"overlay_next": "Right Trigger",
	&"overlay_previous": "Left Trigger",
	&"undo": "Left Stick Click",
	&"redo": "Back / View",
	&"launch_focus": "Start / Menu",
	&"pause_playback": "South / A",
	&"speed_up": "Right Shoulder",
	&"speed_down": "Left Shoulder",
	&"tick_step": "West / X",
	&"review_event_previous": "Left Shoulder",
	&"review_event_next": "Right Shoulder",
	&"jump_failed_predicate": "West / X",
	&"jump_root_cause": "North / Y",
	&"compare_start_final": "Back / View",
	&"panel_next": "Right Trigger",
	&"panel_previous": "Left Trigger",
}
...
static func default_binding_labels(device: StringName) -> Dictionary:
	match device:
		DEVICE_KEYBOARD:
			return KEYBOARD_DEFAULT_LABELS.duplicate(true)
		DEVICE_CONTROLLER:
			return CONTROLLER_DEFAULT_LABELS.duplicate(true)
	return {}

static func validate_default_device_profile(device: StringName) -> bool:
	var labels: Dictionary = default_binding_labels(device)
	if labels.size() != REQUIRED_ACTIONS.size():
		return false
	for action: StringName in REQUIRED_ACTIONS:
		if not labels.has(action) or String(labels[action]).strip_edges().is_empty():
			return false
	return true
